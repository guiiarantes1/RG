...
const ProdutosConfig = () => {
  ...
  }, [marcaForm, marcas, handleFecharModalMarca, buscarMarcas, paginationMarcas]);

  // Excluir marca
  const handleExcluirMarca = useCallback(async (id) => {
    ...
    <div className="config-modal-content">
      <div className="form-group">
        ...
        <input
          ...
          onChange={(e) => setMarcaForm(prev => ({ ...prev, nome: e.target.value }))}
    ...
    <div className="config-modal-content">
      <div className="form-group">
        ...
        <input
          ...
          value={corForm.nome}
          onChange={(e) => setCorForm(prev => ({ ...prev, nome: e.target.value }))}
          ...
          <div className="config-section">
            <div className="section-header">
              <div>
                ...
                <p className="section-description">Crie, edite e exclua marcas de produtos</p>
              </div>
              <Button
            ...
            <MaterialReactTable
              ...
              muiTableContainerProps={{
                sx: { minHeight: '700px', maxHeight: '700px' }
              }}
              muiTablePaperProps={{
                elevation: 0,
                sx: {
          ...
          <div className="config-section">
            <div className="section-header">
              <div>
                ...
                <p className="section-description">Crie, edite e exclua cores de produtos</p>
              </div>
              <Button
                text="Adicionar Cor"
                variant="primary"
